...
class Fracs(Data):
    """
    Series below correspond element-wise to AGE distribution
    """
...
def fit_params(age_distribution, population_size, time_points, data, guess, bounds=None):
    ...
    def fit(x):
        param = Params(age_distribution, population_size, time_points, *unpack(x))
    ...
    return (Params(age_distribution, population_size, time_points,
...
def fit_population(age_distribution, population_size, time_points, data, guess=None):
    """
    Fit R0, reported and logInitial to specified reported cases
    :param time_points: ???
    :param data:
    :return:
    """
    ...
    param, init_cases, err = fit_params(age_distribution, population_size, time_points, data, guess)
